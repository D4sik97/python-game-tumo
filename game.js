  ...
  function simulate() {
    ...
    const keys = ['gold', 'rare', 'trap', 'monster'];
    ...
    chartInst = new Chart(document.getElementById('lootChart'), {
      type: 'bar',
      data: {
        labels: ['💰 Gold', '💎 Rare', '💀 Trap', '👹 Monster'],
        datasets: [{
          label: 'Count (10,000 runs)',
          data: [simCounts.gold, simCounts.rare, simCounts.trap, simCounts.monster],
          backgroundColor: [COLORS.gold, COLORS.rare, COLORS.trap, COLORS.monster],
          borderRadius: 6,
          borderWidth: 0
        }]
      },
